...
\section{ACADEMIC EXPERIENCE}
	\vspace{-0.1in}	
	\begin{tabbing}
		\hspace{2.3in}\= \hspace{2.35in}\= \kill % set up two tab positions
	...
	\begin{tabbing}
		\hspace{2.3in}\= \hspace{2.1in}\= \kill % set up two tab positions
	...
	\begin{tabbing}
		\hspace{2.3in}\= \hspace{2.in}\= \kill % set up two tab positions
